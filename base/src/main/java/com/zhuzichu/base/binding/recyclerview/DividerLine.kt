...
import com.zhuzichu.base.ext.dip2px
...
class DividerLine(mContext: Context) : RecyclerView.ItemDecoration() {
    ...
    private fun drawVertical(
        ...
        for (i in 0 until childCount) {
            ...
            val right =
                if (dividerSize == 0) left + dip2px(DEFAULT_DIVIDER_SIZE.toFloat()) else left + dividerSize
    ...
    private fun drawHorizontal(
        ...
        for (i in 0 until childCount) {
            ...
            val bottom =
                if (dividerSize == 0) top + dip2px(DEFAULT_DIVIDER_SIZE.toFloat()) else top + dividerSize
            dividerDrawable!!.setBounds(left, top, right, bottom)
            dividerDrawable.draw(c)
        }
    }
